...
3. You grant the project maintainers a license to use your contribution in future commercial extensions (SaaS, premium
   features, etc.)

**Why this exists:**
This ensures i²-Vision can sustainably offer both free open-source and optional paid features in the future—without
restricting anyone's freedom to use the MIT-licensed core forever.
