...
│  verbalization-core │ index-provider │ discovery-api            │
└─────────────────────────────────────────────────────────────────┘
```
...
Clusters detected: 18
  - discovery-validation (319 files)
  - verbalization-core (281 files)
  - vslfc-core (245 files)
  - i2vision-discover (236 files)
  - storage-core (281 files)
  - i2vision-instant (274 files)
  - i2vision-cli (260 files)
  - i2vision-mcp (261 files)
  - discovery-api (215 files)
  - i2vision-architecture (207 files)
  - intent-parser (202 files)
  - llm-client, contracts, architecture-types, index-provider, 
    discovery-engine, link-service, conf-agent-core

--- Discovery Results Summary ---
Total Duration: 204s (3.4 minutes)
Total Clusters: 18
...
**Cluster Timings (parallel execution):**
- Fastest: conf-agent-core (15s), link-service (24s), discovery-engine (27s)
- Average: discovery-api (75s), i2vision-architecture (74s), i2vision-mcp (78s)
- Largest: discovery-validation (204s), verbalization-core (158s), vslfc-core (156s)
...
|------------------------------------------------------------|-----------------------------------|
| Full project analysis (18 clusters, 234 artifacts)         | File-specific context in <100ms   |
...
| Total Artifacts     | 234                               |
| Total Errors        | 0                                 |
| Total Duration      | 204 seconds (3.4 minutes)         |
| Processing          | Parallel (18 clusters concurrent) |

**Latest run:** 2026-05-20 | **Log:** `.vision-ai/logs/discovery-log-*.txt`

*This is a real-world validation that the discovery engine works on complex, multi-module Kotlin projects.*
...
- Architecture detection
- CLI tool
- Self-tested on 18 clusters / 234 artifacts
