    ...
    publications {
        create<MavenPublication>("maven") {
            ...
            pom {
                ...
                url.set("https://github.com/i2vision/discovery-api")
                ...
                scm {
                    connection.set("scm:git:git://github.com/i2vision/discovery-api.git")
                    developerConnection.set("scm:git:ssh://github.com/i2vision/discovery-api.git")
                    url.set("https://github.com/i2vision/discovery-api")
                }
            }
        }
