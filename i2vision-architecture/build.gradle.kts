    ...
    publications {
        create<MavenPublication>("maven") {
            ...
            pom {
                ...
                scm {
                    connection.set("scm:git:git://github.com/alex-lykov/i2vision/i2vision-architecture")
                    developerConnection.set("scm:git:ssh://github.com/alex-lykov/i2vision/i2vision-architecture")
                    url.set("https://github.com/alex-lykov/i2vision/i2vision-architecture")
                }
            }
        }
