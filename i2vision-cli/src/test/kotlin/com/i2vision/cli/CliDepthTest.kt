...
class CliDepthTest {
    ...
    fun `should use I2VisionPaths for cache location`() {
        ...
        assertFalse(
            projectCacheDir.absolutePath.contains(projectPath),
        ...
        assertTrue(
            projectCacheDir.absolutePath.contains(userHome) ||
    ...
    fun `should not create semantic cache in project root`() {
        ...
        try {
            ...
            assertFalse(
                projectCacheDir.absolutePath.contains(tempDir.absolutePath),
