    ...
    publications {
        create<MavenPublication>("maven") {
            ...
            pom {
                ...
                url.set("https://github.com/i2vision/i2vision-mcp")
                ...
                scm {
                    connection.set("scm:git:git://github.com/i2vision/i2vision-mcp.git")
                    developerConnection.set("scm:git:ssh://github.com/i2vision/i2vision-mcp.git")
                    url.set("https://github.com/i2vision/i2vision-mcp")
                }
            }
        }
